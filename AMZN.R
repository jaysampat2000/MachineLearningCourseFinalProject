...
amzn_clean <- amzn_data[,-c(1, 18, 25)]
amzn_clean <- na.omit(amzn_clean)

# Split data into training and test sets
set.seed(111111)  # For reproducibility
total_obs <- dim(amzn_clean)[1]
...
train_data <- amzn_clean[1:split_index,]
test_data <- amzn_clean[(split_index + 1):total_obs,]
