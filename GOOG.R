...
goog_clean <- goog_data[,-c(1, 18, 25)]
goog_clean <- na.omit(goog_clean)

# Split data into training and test sets
set.seed(111111)  # For reproducibility
total_obs <- dim(goog_clean)[1]
...
train_data <- goog_clean[1:split_index,]
test_data <- goog_clean[(split_index + 1):total_obs,]
